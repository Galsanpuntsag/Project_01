  ...
  return (
    <div className="mx-auto 2xl:w-4/5">
      <div className="flex justify-around gap-10 mt-5 p-5">
        <div className="w-[250px] bg-transparent h-[140px] 2xl:w-[350px] 2xl:h-[200px]">
        ...
        <div className="w-[300px] h-[150px] rounded-xl bg-slate-50 px-4 py-3 2xl:w-[350px] 2xl:h-[230px]">
